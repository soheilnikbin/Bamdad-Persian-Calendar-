...
import com.omninotes.models.adapters.NavDrawerAdapter;
import com.omninotes.models.misc.DynamicNavigationLookupTable;
import com.omninotes.models.views.NonScrollableListView;
import com.omninotes.utils.Constants;
import com.omninotes.utils.Navigation;
...
public class MainMenuTask extends AsyncTask<Void, Void, List<NavigationItem>> {
    ...
    protected void onPostExecute(final List<NavigationItem> items) {
        if (isAlive()) {
            mDrawerList.setAdapter(new NavDrawerAdapter(mainActivityPep, items));
    ...
    private List<NavigationItem> buildMainMenu() {
        ...
        String[] mNavigationArray = mainActivityPep.getResources().getStringArray(R.array.navigation_list);
        TypedArray mNavigationIconsArray = mainActivityPep.getResources().obtainTypedArray(R.array.navigation_list_icons);
        TypedArray mNavigationIconsSelectedArray = mainActivityPep.getResources().obtainTypedArray(R.array
    ...
    private boolean checkSkippableItem(int i) {
        ...
        SharedPreferences prefs = mainActivityPep.getSharedPreferences(Constants.PREFS_NAME, Context.MODE_MULTI_PROCESS);
