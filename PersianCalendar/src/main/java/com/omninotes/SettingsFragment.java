...
import com.omninotes.async.DataBackupIntentService;
...
public class SettingsFragment extends PreferenceFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		int xmlId = getXmlId() > 0 ? getXmlId() : R.xml.settings_pep;
	...
	public void onResume() {
		...
		if (export != null) {
			export.setOnPreferenceClickListener(arg0 -> {
				...
				View v = inflater.inflate(R.layout.dialog_backup_layout_pep, null);
		...
		// Import notes
		Preference importData = findPreference("settings_import_data_pep");
		if (importData != null) {
...
//		});
		...
		if (lang != null) {
			...
			lang.setOnPreferenceChangeListener((preference, value) -> {
				...
				MiscUtils.restartApp(getActivity().getApplicationContext(), MainActivityPep.class);
				return false;
			});
		}
		...
		if (changelog != null) {
			changelog.setOnPreferenceClickListener(arg0 -> {
				...
				new MaterialDialog.Builder(activity)
						.customView(R.layout.activity_changelog_pep, false)
