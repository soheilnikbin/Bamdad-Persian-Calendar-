...
public abstract class WidgetProvider extends AppWidgetProvider {
    ...
    public static String EXTRA_WORD = "com.omninotes.widget.WORD";
    public static String TOAST_ACTION = "com.omninotes.widget.NOTE";
    public static String EXTRA_ITEM = "com.omninotes.widget.EXTRA_FIELD";
    ...
    private void setLayout(Context context, AppWidgetManager appWidgetManager, int widgetId) {
        ...
        Intent intentDetail = new Intent(context, MainActivityPep.class);
        ...
        Intent intentList = new Intent(context, MainActivityPep.class);
        ...
        Intent intentDetailPhoto = new Intent(context, MainActivityPep.class);
