...
public class NavDrawerAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.drawer_list_item_pep, parent, false);
        ...
        if (isSelected(position)) {
            ...
            int color = mActivity.getResources().getColor(R.color.colorAccent);
            holder.imgIcon.setColorFilter(mActivity.getResources().getColor(R.color.colorAccent));
            ...
            holder.txtTitle.setTextColor(mActivity.getResources().getColor(R.color.textLightGray));
        }
    ...
    private boolean isSelected(int position) {
        ...
        String navigationTmp = MainActivityPep.class.isAssignableFrom(mActivity.getClass()) ? ((MainActivityPep) mActivity)
