package com.omninotes.models.views;
...
import com.omninotes.models.listeners.AbsListViewScrollDetector;
import com.omninotes.models.listeners.OnFabItemClickedListener;
...
public class Fab {
    ...
    private void init() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            Log.e("topMargin"," "+params.topMargin);
            Log.e("rightMargin"," "+params.rightMargin);
            Log.e("bottomMargin"," "+params.bottomMargin);
        }
    }
