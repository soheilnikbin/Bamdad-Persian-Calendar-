 ...
 */
package com.omninotes.receiver;
...
import com.omninotes.SnoozeActivity;
import com.omninotes.models.Note;
import com.omninotes.utils.BitmapHelper;
import com.omninotes.utils.Constants;
import com.omninotes.utils.NotificationsHelper;
...
public class AlarmReceiver extends BroadcastReceiver {
	...
	private void createNotification(Context mContext, Note note) {
		...
		notificationsHelper.getBuilder()
				.addAction(R.drawable.ic_material_reminder_time_light, com.omninotes.utils.TextHelper
						.capitalize(mContext.getString(R.string.snooze)) + ": " + snoozeDelay, piSnooze)
				.addAction(R.drawable.ic_remind_later_light,
						com.omninotes.utils.TextHelper.capitalize(mContext.getString(R.string
