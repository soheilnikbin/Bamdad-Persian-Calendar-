...
public class DrawerAdapterRecurrence extends RecyclerView.Adapter<DrawerAdapterRecurrence.ViewHolder> {
    ...
    public DrawerAdapterRecurrence(MainActivity mainActivity) {
        this.mainActivity = mainActivity;
        utils = Utils.getInstance(mainActivity);
        drawerTitles = mainActivity.getResources().getStringArray(R.array.drawerTitles_recurrence);
        drawerSubtitles = mainActivity.getResources().getStringArray(R.array.drawerSubtitles_recurrence);
        drawerIcon = mainActivity.getResources().obtainTypedArray(R.array.drawerIcons_recurrence);
    }
    ...
    @Override
    public DrawerAdapterRecurrence.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_ITEM) {
    ...
    @Override
    public void onBindViewHolder(DrawerAdapterRecurrence.ViewHolder holder, int position) {
