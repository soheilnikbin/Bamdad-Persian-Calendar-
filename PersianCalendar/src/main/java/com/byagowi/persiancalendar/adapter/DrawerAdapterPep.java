...
import com.omninotes.NavigationDrawerFragment;

public class DrawerAdapterPep extends RecyclerView.Adapter<DrawerAdapterPep.ViewHolder> {
    private final NavigationDrawerFragment navFragment;
    ...
    public DrawerAdapterPep(NavigationDrawerFragment navFragment) {
        this.navFragment = navFragment;
        utils = Utils.getInstance(navFragment.getActivity());
        drawerTitles = navFragment.getResources().getStringArray(R.array.drawerTitles_pep_menu);
        drawerSubtitles = navFragment.getResources().getStringArray(R.array.drawerSubtitles_pep_menu);
        drawerIcon = navFragment.getResources().obtainTypedArray(R.array.drawerIcons_pep_menu);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            navFragment.onClickItem(getAdapterPosition());
        }
    }

    @Override
    public DrawerAdapterPep.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_ITEM) {
    ...
    @Override
    public void onBindViewHolder(DrawerAdapterPep.ViewHolder holder, int position) {
