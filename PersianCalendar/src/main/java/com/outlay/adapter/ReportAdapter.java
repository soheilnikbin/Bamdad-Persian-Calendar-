...
public class ReportAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_CHART) {
            final View v = inflater.inflate(R.layout.layout_chart_expense, parent, false);
            result = new ChartViewHolder(v);

        } else {
            final View v = inflater.inflate(R.layout.item_report_expense, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof ReportViewHolder) {
            ...
            //ADD_PERSIAN_NUMBER
            reportHolder.amountText.setText(ConvertPersianCal.toPersianNumber(NumberTextWatcherForThousand.getDecimalFormattedString(FormatUtils.formatAmount(currentReport.getAmount()))));
    ...
    private void updateChartData(List<Report> reports, PieChart chart) {
        ...
        for (int i = 0; i < reports.size(); i++) {
            ...
            sum += r.getAmount();
            Log.e("Report", " "+r.getAmount());
            Log.e("sum", " "+sum);
            entries.add(new Entry(Float.parseFloat(String.valueOf(r.getAmount())), i));
        ...
        data.setValueFormatter(new ValueFormatter() {
            ...
            public String getFormattedValue(float value, Entry entry, int dataSetIndex, ViewPortHandler viewPortHandler) {
                ...
                String chartvalue =  ConvertPersianCal.toPersianNumber(NumberTextWatcherForThousand.getDecimalFormattedString(FormatUtils.formatAmount((double)value)));
                return chartvalue;
            }
        });
        ...
        chart.setData(data);
        //ADD_PERSIAN_NUMBER
        chart.setCenterText(ConvertPersianCal.toPersianNumber(NumberTextWatcherForThousand.getDecimalFormattedString(FormatUtils.formatAmount(sum))));
