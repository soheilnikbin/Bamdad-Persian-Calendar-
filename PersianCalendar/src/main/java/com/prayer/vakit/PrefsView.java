...
import com.prayer.utils.NumberPickerDialog;
import com.prayer.utils.NumberPickerDialog.OnNumberSetListener;
import com.prayer.utils.PermissionUtils;
import com.prayer.vakit.sounds.SoundChooser;
import com.prayer.vakit.sounds.SoundChooser.Callback;
import com.prayer.vakit.sounds.Sounds;
import com.prayer.vakit.sounds.Sounds.Sound;
...
public class PrefsView extends View implements OnClickListener {
    ...
    public void draw(Canvas canvas) {
        ...
        mPaint.setColor(active ? 0xff00796b: 0xffe0e0e0);
        int w = getHeight();
    ...
    public void onClick(View v) {
        ...
        if ((mPref == Pref.Sound) || (mPref == Pref.Dua) || (mPref == Pref.Sela)) {
            ...
            View view = inflater.inflate(R.layout.sabahtime_dialog_prayer, null);
