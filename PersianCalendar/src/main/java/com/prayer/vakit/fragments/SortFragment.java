...
public class SortFragment extends Fragment implements Times.OnTimesListChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle bdl) {
        View v = inflater.inflate(R.layout.vakit_sort_main_prayer, container, false);

        hintText = (TextView) v.findViewById(R.id.text_hint);
        hintImage = (ImageView) v.findViewById(R.id.arrow_down);
    ...
    private class MyAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View v = LayoutInflater.from(getContext()).inflate(R.layout.vakit_sort_item_prayer, parent, false);
