...
public class RecurrencePickerDialogFragment extends DialogFragment implements OnItemSelectedListener,
    ...
    public void onDateSet(DatePickerDialog view, int year, int monthOfYear, int dayOfMonth) {
        ...
        mModel.endDate.year = civilDate.getYear();
        mModel.endDate.month = civilDate.getMonth() - 1;
        mModel.endDate.monthDay = civilDate.getDayOfMonth();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        for (int i = 0; i < 7; i++) {
            ...
            switch (idx){
                case 0:
                    mWeekByDayButtons[idx].setTextOff("۱ شنبه");
                    break;
                case 1:
                    mWeekByDayButtons[idx].setTextOff("۲ شنبه");
                    break;
                case 2:
                    mWeekByDayButtons[idx].setTextOff("۳ شنبه");
                    break;
                case 3:
                    mWeekByDayButtons[idx].setTextOff("۴ شنبه");
                    break;
                case 4:
                    mWeekByDayButtons[idx].setTextOff("۵ شنبه");
                    break;
                case 5:
                    mWeekByDayButtons[idx].setTextOff("جمعه");
                    break;
                case 6:
                    mWeekByDayButtons[idx].setTextOff("شنبه");
                    break;
            }
            switch (idx){
                case 0:
                    mWeekByDayButtons[idx].setTextOn("۱ شنبه");
                    break;
                case 1:
                    mWeekByDayButtons[idx].setTextOn("۲ شنبه");
                    break;
                case 2:
                    mWeekByDayButtons[idx].setTextOn("۳ شنبه");
                    break;
                case 3:
                    mWeekByDayButtons[idx].setTextOn("۴ شنبه");
                    break;
                case 4:
                    mWeekByDayButtons[idx].setTextOn("۵ شنبه");
                    break;
                case 5:
                    mWeekByDayButtons[idx].setTextOn("جمعه");
                    break;
                case 6:
                    mWeekByDayButtons[idx].setTextOn("شنبه");
                    break;
            }
    ...
    public void onClick(View v) {
        if (mEndDateTextView == v) {
            ...
            com.mohamadamin.persianmaterialdatetimepicker.date.DatePickerDialog dpd = com.mohamadamin.persianmaterialdatetimepicker.date.DatePickerDialog.newInstance(
                    RecurrencePickerDialogFragment.this,
                    now.getPersianYear(),
                    now.getPersianMonth(),
                    now.getPersianDay());
            ...
            dpd.show(getActivity().getFragmentManager(), FRAG_TAG_DATE_PICKER);
